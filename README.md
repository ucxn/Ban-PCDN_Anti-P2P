...
> <span style="color:#7F8C8D;">*小贴士：能在应用层解决的问题（比如用“李跳跳”去广告），就不要在三层网络层折腾。手机端看 B站建议直接上第三方客户端（如 [PiliPlus](https://github.com/ucxn/Bili.Libre.Speed)），电脑端永远只用 Web 网页版并配合篡改猴插件！*</span>
