...
作为有线网络原教旨主义倡导者，我们坚决抵制为了屏蔽几个域名，部署基于 Arm 架构的“软路由”或繁冗的应用层插件、小主机或各类花里胡哨的插件。**真正的极客，追求的是硬路由的 NPU 线速转发！** 用最暴力的防火墙策略，守护最纯净的 Open Internet。不搞暴力无脑流控QoS，把所有的算力留给真正的业务，这才是美式的“量大管饱”。
